...
export default class BMPDecoder {
  ...
  constructor(bufferData: Buffer) {
    ...
    this.xPixelsPerM = this.bufferData.seek(38).readInt32();
    this.yPixelsPerM = this.bufferData.readInt32();
    if (this.bitDepth !== 1) {
  ...
  decode(): ImageCodec {
    ...
    return {
      ...
      components,
      data,
      yPixelsPerMeter: this.yPixelsPerM,
      xPixelsPerMeter: this.xPixelsPerM,
    };
  }
}
